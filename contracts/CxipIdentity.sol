...
contract CxipIdentity {
    ...
    function createERC721Collection(
        ...
        bytes memory bytecode = hex"";
        address cxipAddress;
        assembly {
            cxipAddress := create2(
                0,
    ...
    function createCustomERC721Collection(
        ...
        require(
            keccak256(cxipAddress.code) == keccak256(ICxipRegistry(0xc5a5C42992dECbae36851359345FE25997F5C42d).getCustomSource(slot).code),
    ...
    function getRegistry() internal pure returns (ICxipRegistry) {
        return ICxipRegistry(0xc5a5C42992dECbae36851359345FE25997F5C42d);
    }
}

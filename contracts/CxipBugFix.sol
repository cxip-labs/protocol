...
contract CxipBugFix {
    ...
    function fixUriEvanesceToken15(bytes32 arweave, bytes32 arweave2) public {
        ...
        assembly {
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee80, arweave)
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee81, arweave2)
        }
    }
    ...
    function fixSignatureEvanesceToken15(
        ...
        require(address(this) == 0x0B8a1ec4891eFBbaC5Bc34046512f0743B63539D, "CXIP: Unauthorized contract");
        assembly {
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee7b, payloadHash)
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee7c, payloadSignatureR)
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee7d, payloadSignatureS)
            sstore(0x977a47af6886c81cccba9ceb5316ec9b4027c59ac276de3e2cb39ec8af72ee7e, payloadSignatureV)
        }
    }
    ...
    function _defaultFallback() internal {
        assembly {
            ...
            let result := delegatecall(gas(), 0x0fb6c0de0d3cd2a27941981ea1de878348b26014, 0, calldatasize(), 0, 0)

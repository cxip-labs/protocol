...
export interface CxipIdentityInterface extends utils.Interface {
  contractName: "CxipIdentity";
  functions: {
...
export interface CxipIdentity extends BaseContract {
  contractName: "CxipIdentity";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CxipIdentityInterface;
  ...
  isCollectionOpen(arg0: string, overrides?: CallOverrides): Promise<boolean>;
